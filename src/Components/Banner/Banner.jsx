        ...
        <div className="conatiner">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-0">
                    <h1 data-aos="fade-up" className="text-3x1 m:text-4x1 font-bold">Winter sale upto 50% off</h1>
                    <p data-aos="fade-up" className="text-sm text-grey-500 tracking-wide loading-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur sint similique ab ipsum quos odit hic vero ipsa beatae tenetur eius itaque quod temporibus earum labore molestias, aliquam a voluptatem fugit facilis?</p>
